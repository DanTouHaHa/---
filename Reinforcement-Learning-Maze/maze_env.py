...
class Maze(tk.Tk, object):
    def __init__(self, agentXY, goalXY, walls=[], pits=[], MAZE_H=10, MAZE_W=10, UNIT=20):
    ...
    def reset(self,  start_point=None, end_point=None, value = 1, resetAgent=True):
        ...
        if(value == 0):
            ...
            if(resetAgent):
                ...
                #self.agent = self.canvas.create_rectangle(origin[0] - self.UNIT/2, origin[1] - self.UNIT/2,
                #origin[0] + self.UNIT/2, origin[1] + self.UNIT/2,
                #fill='red')
